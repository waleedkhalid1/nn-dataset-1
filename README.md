...
```bash
python run.py -c img_classification-cifar10-acc-AlexNet --min_learning_rate 0.0061 -l 0.0061 --min_momentum 0.7549 -m 0.7549 --min_batch_binary_power 2 -b 2 -f cifar10_norm --epochs -1
```
