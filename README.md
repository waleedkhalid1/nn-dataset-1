...
<li> all neural network models not eligible for the above licenses, as well as all other files and assets in this project, are subject to the <a href="LICENSE.md">MIT License</a></li> 
</ul>
